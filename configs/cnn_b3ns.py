...
cfg.PRECISION = 32
cfg.seed = {
    "pretrain_ce": 20171121,
    "pretrain_bce": 20170503,
    "train_ce": 20171019,
    "train_bce": 2017101911,
    #"finetune": 20230523,
}
...
cfg.model_ckpt = {
    "pretrain_ce": None,
    "pretrain_bce": "outputs/cnn_b3ns/pytorch/pretrain_ce/last.ckpt",
    "train_ce": None,
    # "train_ce": "outputs/cnn_b3ns/pytorch/pretrain_bce/last.ckpt",
    "train_bce": "outputs/cnn_b3ns/pytorch/train_ce/last.ckpt",
    #"finetune": "outputs/cnn_b3ns/pytorch/train_bce/last.ckpt",
}

cfg.output_path = {
    "pretrain_ce": "outputs/cnn_b3ns/pytorch/pretrain_ce",
    "pretrain_bce": "outputs/cnn_b3ns/pytorch/pretrain_bce",
    "train_ce": f"outputs/cnn_b3ns/pytorch/train_ce/{cfg.exp}",
    "train_bce": "outputs/cnn_b3ns/pytorch/train_bce",
    #"finetune": "outputs/cnn_b3ns/pytorch/finetune",
}

cfg.final_model_path = f"outputs/cnn_b3ns/pytorch/train_ce/{cfg.exp}/last.ckpt"
cfg.onnx_path = f"outputs/cnn_b3ns/onnx/{cfg.exp}"
cfg.openvino_path = f"outputs/cnn_b3ns/openvino/{cfg.exp}"
...
cfg.am_audio_transforms = amCompose([
    AddBackgroundNoise(cfg.birdclef2021_nocall + cfg.rainforest, min_snr_in_db=3.0,max_snr_in_db=30.0,p=0.6),
