...
cfg.output_path = {
    ...
    "train_ce": f"outputs/cnn_b0ns/pytorch/train_ce/{cfg.exp}",
    #"train_bce": "outputs/cnn_b0ns/pytorch/train_bce",
    #"finetune": "outputs/cnn_b0ns/pytorch/finetune",
}

# cfg.final_model_path = "outputs/cnn_b0ns/pytorch/train_ce/ckpt_epoch_epoch=45_val_loss=2.71.ckpt"
cfg.final_model_path = f"outputs/cnn_b0ns/pytorch/train_ce/{cfg.exp}/last.ckpt"
cfg.onnx_path = f"outputs/cnn_b0ns/onnx/{cfg.exp}"
cfg.openvino_path = f"outputs/cnn_b0ns/openvino/{cfg.exp}"
